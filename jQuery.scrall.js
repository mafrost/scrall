...
(function(global, $) {
    var Scrall = (function() {
        ...
        //window needed to get scrolltop and add listener
        $window = $(window),
        
        //array with our function calls 
        calls = [], 
        
        //extends the default call
        extendDefaults = function(params) {
            //a default call, no function, no area
            var call = $.extend({
                elem : null,
                top : 0,
                bot : 0,
        ...
        //check which calls to perform
        checkScroll = function() {
            var i, numOfCalls = calls.length, pos = $window.scrollTop();

            for ( i = 0; i < numOfCalls; i++) {
                var oldIn = calls[i].isIn, param = {
